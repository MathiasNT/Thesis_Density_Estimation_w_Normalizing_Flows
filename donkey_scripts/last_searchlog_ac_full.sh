...
# Experiment settings
OVER_RUN_FOLDER=results/coordinatesearchlog/last
RESULTS_FOLDER="$OVER_RUN_FOLDER/run2"
...
python3 semisup_searchlog_script.py --experiment_name $EXPERIMENT_NAME --results_folder $RESULTS_FOLDER --data_folder $DATA_FOLDER --data_file $DATA_FILE --extra_data_file $EXTRA_DATA_FILE --cuda_exp $CUDA_EXP\
