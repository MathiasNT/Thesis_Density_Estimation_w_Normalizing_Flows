...
python3 semisup_no_semi_searchlog_script_planar.py --experiment_name $EXPERIMENT_NAME --results_folder $RESULTS_FOLDER --data_folder $DATA_FOLDER --data_file $DATA_FILE --extra_data_file $EXTRA_DATA_FILE --cuda_exp $CUDA_EXP\
