...
#BSUB -N 
#BSUB -o logs/%J_Output_ac.out 
#BSUB -e logs/%J_Error_ac.err
...
EXPERIMENT_NAME=affine_coupling
echo $EXPERIMENT_NAME
python3 semisup_w_prior_searchlog_script.py --experiment_name $EXPERIMENT_NAME --results_folder $RESULTS_FOLDER --data_folder $DATA_FOLDER --data_file $DATA_FILE --extra_data_file $EXTRA_DATA_FILE --cuda_exp $CUDA_EXP\
