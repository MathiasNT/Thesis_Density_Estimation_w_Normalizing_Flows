...
#BSUB -N 
#BSUB -o logs/%J_Output_planar.out 
#BSUB -e logs/%J_Error_planar.err


# Experiment settings
OVER_RUN_FOLDER=results/coordinatesearchlog/last_w_prior_48
...
EXPERIMENT_NAME=planar
echo $EXPERIMENT_NAME
python3 semisup_w_prior_searchlog_script_planar.py --experiment_name $EXPERIMENT_NAME --results_folder $RESULTS_FOLDER --data_folder $DATA_FOLDER --data_file $DATA_FILE --extra_data_file $EXTRA_DATA_FILE --cuda_exp $CUDA_EXP\
