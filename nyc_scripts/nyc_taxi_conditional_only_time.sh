...
# Experiment settings
OVER_RUN_FOLDER=results/nyc_taxi/time_only/test1
RESULTS_FOLDER="$OVER_RUN_FOLDER/run4"
...
CONTEXT_COLS="pickup_dow_sin pickup_dow_cos pickup_tod_sin pickup_tod_cos"
