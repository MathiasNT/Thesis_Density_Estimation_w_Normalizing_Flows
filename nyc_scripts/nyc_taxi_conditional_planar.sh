...
#BSUB -N 
#BSUB -o logs/%J_Output_nyc_planar.out 
#BSUB -e logs/%J_Error_nyc_planar.err

echo "Starting:"

# Experiment settings
OVER_RUN_FOLDER=results/nyc_taxi/conditional/deep_planar2
...
EXPERIMENT_NAME=nyc_model_planar2
NOISE_REG_SIGMA=0.08
echo $EXPERIMENT_NAME
python3 planar_conditional_simple_script.py --experiment_name $EXPERIMENT_NAME --results_folder $RESULTS_FOLDER --data_folder $DATA_FOLDER --data_file $DATA_FILE --cuda_exp $CUDA_EXP\
