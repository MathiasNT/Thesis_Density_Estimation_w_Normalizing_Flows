#!/bin/sh 
#BSUB -J Synthetic_BN_large_momentum
...
OVER_RUN_FOLDER=results/two_moons/unreg_run_bn_hig_hmomentum
BASE_RESULTS_FOLDER=$OVER_RUN_FOLDER/unreg_comparison_full3
...
mkdir $BASE_RESULTS_FOLDER/batchnorm
mkdir $BASE_RESULTS_FOLDER/batchnorm_and_clipped_adam
...
for DATA_SIZE in 100 200 300 400 500 600 700 800 900 1000 1200 1400 1600 1800 2000 2500 3000 3500 4000 5000 6000 7000 8000 9000; do
	EXPERIMENT_NAME=batchnorm_$DATA_SIZE
	RESULTS_FOLDER=$BASE_RESULTS_FOLDER/batchnorm
...
echo " Batch Norm and Clipped Adam ******************************************"
BATCHNORM_MOMENTUM=0.9
CLIPPED_ADAM=10.0
for DATA_SIZE in 100 200 300 400 500 600 700 800 900 1000 1200 1400 1600 1800 2000 2500 3000 3500 4000 5000 6000 7000 8000 9000; do
	EXPERIMENT_NAME=batchnormclippedadam_$DATA_SIZE
	RESULTS_FOLDER=$BASE_RESULTS_FOLDER/batchnorm_and_clipped_adam
	python3 synthetic_script.py --experiment_name $EXPERIMENT_NAME --results_folder $RESULTS_FOLDER --data_folder $DATA_FOLDER --data_file $DATA_FILE --cuda_exp $CUDA_EXP\
        	                    --data_size $DATA_SIZE \
                	            --noise_reg_scheduler $NOISE_REG_SCHEDULER --noise_reg_sigma $NOISE_REG_SIGMA\
